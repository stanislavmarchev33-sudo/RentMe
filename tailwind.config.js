    ...
    theme: {
      extend: {
        ...
        keyframes: {
          ...
          'pulse-glow': {
            '0%, 100%': { boxShadow: '0 0 20px rgba(123, 47, 247, 0.25)' },
            '50%': { boxShadow: '0 0 40px rgba(233, 30, 140, 0.4)' },
          },
          'shimmer': {
        ...
        boxShadow: {
          'brand': '0 4px 24px rgba(123, 47, 247, 0.18)',
          'brand-lg': '0 8px 40px rgba(123, 47, 247, 0.22)',
          'card': '0 2px 16px rgba(30, 42, 110, 0.08)',
          'card-hover': '0 8px 32px rgba(30, 42, 110, 0.14)',
        }
      },
    },
